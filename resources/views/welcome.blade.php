...
<nav class="bg-white  border-gray-200 p-5 drop-shadow-lg">
    <div class="flex flex-wrap justify-end mx-auto items-center max-w-screen-xl gap-6">
...
<section class="bg-white dark:bg-gray-900 flex justify-center items-center">
        <div
            ...
            <div class="mt-4 md:mt-0">
                <h2 class="mb-4 py-2 text-4xl tracking-tight font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-pink-600 to-purple-600">Let's create more
                 ...
                 @if (Route::has('login'))
                            <nav class="flex flex-1 justify-start gap-4">
                                @auth
                                    <a
                                        href="{{ url('/dashboard') }}"
                                        class="rounded-md px-3 py-2 text-white font-semibold bg-slate-500 ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white"
                                    >
                                        Dashboard
                                    </a>
                                @else
